...
namespace Rayni
{
	...
	protected:
		...
		static std::vector<std::uint8_t> exr_data_1x1()
		{
		...
		static std::vector<std::uint8_t> jpeg_data_1x1()
		{
		...
		static std::vector<std::uint8_t> png_data_1x1()
		{
	...
	TEST_F(ImageReaderTest, ReadFile)
	{
